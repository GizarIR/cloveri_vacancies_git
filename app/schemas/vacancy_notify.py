...
from .vacancy import ContactType, Contact, Conditions, Requirements
from .vacancy_skill import CreateVacancySkillNested, VacancySkillNested


class BaseVacancyNotifyNoSkills(BaseModel):
    name: str
...
class BaseVacancyNotify(BaseVacancyNotifyNoSkills):
...
class VacancyNotify(BaseVacancyNotify):
    id: UUID
    created_on: datetime
    updated_on: datetime


class PostTelegramVacancy(BaseVacancyNotify):
